...
対象: `.bash_profile`, `.bashrc`, `.gitconfig`, `.gitignore_global`, `ghostty/config`, `starship.toml`

### Ghostty

[Ghostty](https://ghostty.org/) のターミナル設定。`setup.sh` で `~/.config/ghostty/config` にリンクされる。
